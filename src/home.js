...
const Home = () => {
  return (
    <div className="home-container flex flex-col justify-center items-center h-[100vh] absolute inset-0">
      ...
      <div className='absolute'>
        ...
        <div className='flex flex-row justify-center items-center mt-6 animate-fadeInLeft delay-[2s]'>
          <button class="inline-flex items-center h-10 px-5 py-8 text-indigo-100 transition-colors duration-150 bg-gradient-to-b from-[#5200ff] to-[#3d00bd] hover:opacity-85 rounded-full">
